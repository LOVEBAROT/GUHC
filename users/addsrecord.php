...
<div class="heading">
    <h2 align="center">Add Student Case Record Form</h2>
</div>
<div class="form">
    <div class="inner">
        <form action="addsrecord.php" method="post">
            <table border="1" align="center" width="1400px">
                ...
                <tr>
                    <td><input type="text" name="cno" value="<?php if(isset($_SESSION['cno1'])){ echo $_SESSION['cno1']; unset($_SESSION['cno1']); } ?>"  placeholder="Enter Student Case Number" required> <input type="submit" name="show"  value="show" class="btn"></td>
                    ...
                    <input type="hidden" name="ctype" value="Student">
                </tr>
